...
const NAV = [
  ...
  { sec: 'Movimientos',   items: [{ id: 'movements', ic: '⇄', lb: 'Movimientos' }] },
  { sec: 'Herramientas',  items: [{ id: 'subscriptions', ic: '↻', lb: 'Suscripciones' }, { id: 'coach', ic: '◈', lb: 'Coach' }, { id: 'import', ic: '↑', lb: 'Importar movimientos' }] },
